...
import { Dropdown, Space, Layout, Menu, Modal, Col, Row } from 'antd'
    ...
    items={[
      {
        ...
        label: (
          <NavLink to="/AdmPersonal/AdmPersonalSet">修改密码</NavLink>
        ),
        onClick: onClicks,
      },
      {
        ...
        icon: <UserOutlined />,
        label: (
          <NavLink to="/AdmPersonal/AdmPersonalSet">个人中心</NavLink>
        ),
      },
      {
        type: 'divider',
...
const items = [
  getItem(<NavLink to="/AdmIndex">教师账户管理</NavLink>, '1', <SolutionOutlined />),
  getItem(<NavLink to="/Department">系科管理</NavLink>, '2', <FileZipOutlined />),
  getItem(<NavLink to="/Announcement">公告管理</NavLink>, '3', <FileZipOutlined />),
  getItem(<NavLink to="/DepartmentAdmin">系管理员</NavLink>, '4', <SolutionOutlined />),
  getItem(<NavLink to="/TotalDataSummaryAdmin">数据总览</NavLink>, '5', <BarChartOutlined />),
  getItem(<NavLink to="/StudentSearchAdmin">学生管理</NavLink>, '6', <ContactsOutlined />),
  getItem(<NavLink to="/SemesterDelete">学期课程清理</NavLink>, '7', <ClearOutlined />),
  getItem('个人页', 'sub1', <UserOutlined />, [
    getItem(<NavLink to="/AdmPersonal/AdmPersonalSet">个人设置</NavLink>, '8', <SettingOutlined />),
  ]),
]
  ...
  return (
    <Layout style={{ minHeight: '100vh', }}>
      <Header className="head">
        ...
        <div className="administrator"><UserAddOutlined />总管理员</div>
      </Header>
      <Layout>
